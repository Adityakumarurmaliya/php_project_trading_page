...
<head>
  ...
  <link rel="stylesheet" id="elementor-pro-css"
    ...
    media="all" />
  <!-- <link rel="stylesheet" id="elementor-post-99-css" href="https://kitnew.moxcreative.com/gettrade/wp-content/uploads/sites/8/elementor/css/post-99.css?ver=1685390851" media="all" /> -->
                    ...
                    <div
                      ...
                      <div class="elementor-widget-container">
                        <div class="elementor-button-wrapper">
                          <a href="./contactus.php" class="elementor-button-link elementor-button elementor-size-md"
                            role="button">
                ...
                <div
                  ...
                  <div class="elementor-widget-wrap elementor-element-populated">
                    ...
                    <div
                      ...
                      <div class="elementor-widget-container">
                        <p>
                          Introducing "SUPREMESTOX TRADING" , the ultimate trading tool by SupremStox Trading. Gain a
                          competitive edge in the stock market with real-time data, expert insights, and smart trade
                          recommendations, empowering you to make informed decisions and maximize your profits. Join us
                          today!
                    ...
                    <div class="elementor-element elementor-element-2e0899c elementor-widget elementor-widget-button"
                      ...
                      <div class="elementor-widget-container">
                        <div class="elementor-button-wrapper">
                          <a href="./aboutus.php" class="elementor-button-link elementor-button elementor-size-sm"
                            role="button">
                            <span class="elementor-button-content-wrapper">
              ...
              <div
                ...
                <div class="elementor-widget-wrap elementor-element-populated">
                  ...
                  <div class="elementor-element elementor-element-d3100f5 elementor-widget elementor-widget-button"
                    ...
                    <div class="elementor-widget-container">
                      <div class="elementor-button-wrapper">
                        <a class="elementor-button elementor-button-link elementor-size-sm" href="./contactus.php">
                          <span class="elementor-button-content-wrapper">
                      ...
                      <form action="#" method="post">
                        <div class="contact_form">
                          <div class="cnt_form">
                            ...
                            <input type="text" class="name" id="Full_Name" name="name" placeholder="Full Name"
                              required="">
                            <input type="text" id="phone_number_validation" class="phone" name="contact_no"
                            ...
                            <select name="segments" class="drop_down" required="">
                            ...
                            <div class="check_box_parent">
                              ...
                              <label for="checkbox" class="text_checkbox"> I accept <a href="./userconsent.php"
        ...
        <div
          ...
          <div class="elementor-widget-wrap elementor-element-populated">
            <div
              ...
              <div class="elementor-widget-container">
                <div class="elementor-button-wrapper">
                  <a href="./contactus.php" class="elementor-button-link elementor-button elementor-size-lg"
                    role="button">
                    <span class="elementor-button-content-wrapper">
